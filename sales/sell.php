            ...
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <div>
                        ...
                        <!-- TAG VENDEUR avec nom et rôle -->
                        <div class="vendeur-tag <?= isAdmin() ? 'admin' : 'employee' ?>">
                            <?php if(isAdmin()): ?>
                            <i class="bi bi-shield-fill"></i>
                            <?php else: ?>
                            <i class="bi bi-person-fill"></i>
                            <?php endif; ?>
                            Vendeur : <?= htmlspecialchars($_SESSION['user']) ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="product-info-box" id="productInfo">
                    <div class="info-row">
                        <span>
                            <i class="bi bi-box-seam" style="color:#10b981;margin-right:6px;"></i>
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-hint">
                            <i class="bi bi-info-circle"></i> Les produits en rupture sont désactivés
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="number" name="quantity_sold" id="quantityInput" placeholder="Ex: 2" min="1"
                                required>
                        </div>
